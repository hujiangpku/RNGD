...
dataset = 'school'; % values permitted: 'sarcos', 'school', 'parkinson'.
problem.str = 'sl';
...
options.stepsize = 5e0; % 3e0 for random
options.boost = 0;
...
ylabel(ax1,'NMSE on training set','FontName','Arial','FontSize',fs);
legend('RCG','RSGD', 'RASA', 'RSVRG','RNGD');
